...
export default function ReceivedCard({ onClosePosition, application, navigation, onPress }) {
  ...
  return (
    <View
      style={[
        ...
        {
          opacity:
            !application.post.opened && application.post.closedFor.id != application.id ? 0.5 : 1,
        },
      ]}>
      <View style={styles.upperContent}>
        ...
        <View style={styles.info}>
          <Info
            ...
            posizione={application.post.titolo}></Info>
        </View>
      </View>
          ...
          {application.pubRead ? (
            ...
            <View style={{ flexDirection: 'row' }}>
              ...
              <View
                ...
                <Bold style={{ textAlign: 'center', color: 'white', marginTop: 2 }}></Bold>
              </View>
            </View>
          )}
...
function Info({ navigateToProfile, nome, cognome, messaggio, regione, comune }) {
    ...
    <View style={styles.containerInfo}>
      ...
      {comune ? (
        <LocationWithText
          ...
          style={{ marginTop: 3 }}
          comune={comune}
          regione={regione}></LocationWithText>
      ) : null}
      <Body style={{ fontSize: 14, marginTop: 15, color: Colors.blue }}>Risposta</Body>
