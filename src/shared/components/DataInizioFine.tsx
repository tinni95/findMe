...
import WithErrorString from './Form/WithErrorString';
import DataOverlayModal from './DataOverlayModal';

export default function DataInizioFine({
  dataInizio,
  setDataInizio,
  dataFine,
  setDataFine,
  ...
  return (
    <View>
      ...
      <DataOverlayModal
        ...
        setDate={setDataInizio}></DataOverlayModal>
      <DataOverlayModal
        fine={true}
        modalVisibile={modal1Visibile}
        setModalVisible={setModal1Visible}
        setDate={setDataFine}></DataOverlayModal>
    </View>
  );
}
