  ...
  const [createApplication] = useMutation(CREATEAPPLICATION_MUTATION, {
    onCompleted: async ({ createApplication }) => {
      ...
      sendNotification(
        ...
        post.titolo,
        data.currentUser.nome + ' si è applicato alla tua posizione di ' + post.titolo,
      );
      UnseeApplication({
        ...
        <View style={styles.textWrapper}>
          ...
          <Text>
            <Light style={{ lineHeight: 20 }}>
              Scrivi a {post.postedBy.nome} Per informargli del tuo interesse per la posizione di
            </Light>
          ...
          <View style={styles.buttonWrapper}>
            <RoundButton
              ...
              color={Colors.red}
              textColor={'white'}
              onPress={() => handleApply()}></RoundButton>
          </View>
        </View>
      </View>
    </KeyboardAwareScrollView>
