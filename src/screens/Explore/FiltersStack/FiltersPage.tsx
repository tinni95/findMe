    ...
    <View style={styles.container}>
      <ScrollView>
        <StepsLabelWithHint
          ...
          text={'Settori di preferenza'}></StepsLabelWithHint>
        <MultiFilters
          reset={reset}
          hide
...
FiltersPage.navigationOptions = ({ navigation }) => {
  return {
    ...
    headerLeft: () => (
      <HeaderLeft
        onPress={() => navigation.navigate('Explore', navigation.state.params)}></HeaderLeft>
    ),
    headerRight: () => (
      <HeaderRight text={'Azzera Filtri'} onPress={() => navigation.getParam('azzera', null)()} />
    ),
  };
};
