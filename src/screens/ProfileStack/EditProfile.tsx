...
import StepsLabel, { StepsLabelWithHint } from '../../shared/components/StepsLabel';
...
function EditProfile({ navigation, route }) {
  ...
  }, [nome, cognome, regione, provincia, comune, image, base64, posizione, DoB]);
        ...
        <KeyboardAwareScrollView ref={scrollview} contentContainerStyle={{ margin: 20 }}>
          {!zoom && (
            <View>
              ...
              <WithErrorString error={nomeError} errorText={'Campo Obbligatorio'}>
                <FormTextInput
                  placeholder={'Nome'}
              ...
              <WithErrorString error={cognomeError} errorText={'Campo Obbligatorio'}>
                <FormTextInput
                  placeholder={'Cognome'}
...
EditProfile.navigationOptions = ({ navigation }) => {
  return {
    title: '',
    headerLeft: () => (
      <HeaderLeftWithRoute onPress={() => navigation.navigate('ProfilePage')}></HeaderLeftWithRoute>
    ),
    headerRight: () => (
